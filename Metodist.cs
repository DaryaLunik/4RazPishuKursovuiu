...
namespace _4popitka
{
    internal class Metodist
    {
        ...
        //{
        //    if (File.Exists(specialtyFile))
        //    {
        //        string[] lines = File.ReadAllLines(specialtyFile);
        //        for (int i = 0; i < lines.Length; i++)
        //        {
        //            Specialty s = new Specialty().ToFileString(lines[i]);
        //            if (s != null)
        //                specialties.Add(s);
        //        }
        //    }
        ...
        //        for (int i = 0; i < lines.Length; i++)
        //        {
        //            Department d = new Department().ToFileString(lines[i]);
        //            if (d != null)
        //                departments.Add(d);
        //        }
        //    }
        ...
        //        for (int i = 0; i < lines.Length; i++)
        //        {
        //            Discipline d = new Discipline().ToFileString(lines[i]);
        //            if (d != null)
        //                disciplines.Add(d);
        //        }
        //    }
        ...
        //    }
        //    File.WriteAllLines(specialtyFile, sLines);
        ...
        //    }
        //    File.WriteAllLines(departmentFile, dLines);
        ...
        //    }
        //    File.WriteAllLines(disciplineFile, discLines);
        //}
